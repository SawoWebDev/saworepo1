...
const STATIC_PAGES = [
  ...
  { path: "/infrared/saunas", label: "Infrared Saunas", defaultTitle: "Infrared Saunas", defaultDescription: "SAWO infrared saunas in one- and two-person sizes. Fiber-coated far infrared panels, cedar and hemlock finishes, and plug-and-play 230V installation." },
  { path: "/infrared/panels", label: "Infrared Panels", defaultTitle: "Infrared Panels", defaultDescription: "SAWO infrared panels and accessories — fiber-coated far infrared panels at 170W each, backrests, and interface holders for your infrared sauna." },
  { path: "/infrared/controls", label: "Infrared Controls", defaultTitle: "Infrared Controls", defaultDescription: "SAWO Infrared 2.0 controls — user interface, power controller, and built-in control for managing temperature, session time, lighting, and airflow." },
  ...
  { path: "/sauna/rooms", label: "Sauna Rooms (hub)", defaultTitle: "Sauna Rooms", defaultDescription: "Explore SAWO sauna rooms: Standard, Glass Front, and Compact designs crafted for a complete, therapeutic sauna experience." },
