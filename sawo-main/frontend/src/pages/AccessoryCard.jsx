...
.sawo-av-popup-video{width:100%;height:100%;object-fit:contain;background:#000;z-index:11}
...
export function AccessoryCard({ product }) {
  ...
  return (
    ...
    >
      ...
      {codes.length > 0 && <div className="sawo-av-code"><strong>{tc("accessoryCard.code")}:</strong> {codes.join(" | ")}</div>}
