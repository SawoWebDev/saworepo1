...
const ROOMS_ITEMS = [
  ...
  { title: "Infrared Saunas", caption: "Expertly crafted in cedar, aspen, and spruce. Gentle infrared warmth for soothing, therapeutic comfort.",                                                                                                              img: infraredSaunaRoom,href: menuPaths.infrared.room },
];
const INFRARED_ITEMS = [
  { title: "Infrared Saunas",   caption: "Enjoy gentle, soothing infrared warmth in a comfortable and compact sauna space, designed for a relaxing and restorative experience.",                img: infraredRooms,      href: menuPaths.infrared.room },
