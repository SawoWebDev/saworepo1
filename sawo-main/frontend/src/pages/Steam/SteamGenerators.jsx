  ...
  return (
    <div className="relative">
      ...
      <CategoryHero
        heroImg={heroImg}
        title="Steam Generators"
        description="Experience the luxury of tailored steam with our advanced steam generators, providing reliable performance, customizable settings, and rejuvenating warmth for any space."
      />

      <section className="sg2-intro">
        <div className="sg2-container" style={{ textAlign: "center" }}>
          <h2 className="sg2-title">Introducing Our Steam Generators</h2>
          <p className="sg2-desc">
            Experience the luxury of tailored steam with our advanced steam generators,
            providing reliable performance, customizable settings, and rejuvenating warmth
            for any space.
          </p>
        </div>
      </section>
