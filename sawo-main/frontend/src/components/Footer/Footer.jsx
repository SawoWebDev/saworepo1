      ...
      <div className="max-w-screen-2xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-4 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start border-b border-white lg:border-b-0 lg:border-r lg:border-white pb-4 lg:pb-0">
            ...
            <ul className="space-y-1 text-sm">
              <li><Link to={localize(menuPaths.infrared.saunas)} className="hover:text-gray-300">{t("links.infraredSaunas")}</Link></li>
              <li><Link to={localize(menuPaths.infrared.panels)} className="hover:text-gray-300">{t("links.infraredPanels")}</Link></li>
              <li><Link to={localize(menuPaths.infrared.controls)} className="hover:text-gray-300">{t("links.infraredControls")}</Link></li>
            </ul>
          </div>
